...
import { categories, products } from "../../static/data"
    ...
    <>
      <div className="w-11/12 mx-auto">
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          <div>
            <Link to="/">
              <img src="images/logo-text.png" alt="logo" className="hover:object-scale-down h-20 w-25 hover:scale-105 transition" />
            </Link>
          </div>
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-[2px] border-slate-500 rounded-md"
      ...
      <div className={`${active && "shadow-sm fixed top-0 left-0 z-10"} hidden w-full bg-indigo-400 h-[70px] 800px:flex items-center justify-between transition`}>
        <div className="w-11/12 mx-auto relative flex items-center justify-between">
          <div>
            <div onClick={() => setDropDown(!dropDown)} className="hidden relative h-[60px] mt-[10px] w-[270px] 1000px:block">
          ...
          <div className="flex">
            <div className="flex items-center">
                <div className="relative mr-[15px] cursor-pointer">
                  ...
                  <span className="absolute left-5 bottom-4 rounded-full text-center text-[12px] bg-red-500 text-zinc-50 w-4 h-4 top right leading-tight">
                    0
                  </span>
                </div>  
            </div>
